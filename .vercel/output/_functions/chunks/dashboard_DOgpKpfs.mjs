...
import { t as getNotificationFormatted } from "./notification_CUm7GBp1.mjs";
import * as React$1 from "react";
import { useEffect, useState } from "react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { jsx, jsxs } from "react/jsx-runtime";
import { Bell, Blocks, Calendar, ChevronDown, ChevronUp, Dot, Inbox, Mail, PanelLeftIcon, Search, Settings, XIcon } from "lucide-react";
...
function AppSidebar() {
	...
	return /* @__PURE__ */ jsxs(Sidebar, { children: [
		/* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
			asChild: true,
			children: /* @__PURE__ */ jsxs(SidebarMenuButton, { children: ["Andre Austria", /* @__PURE__ */ jsx(ChevronDown, { className: "ml-auto" })] })
		}), /* @__PURE__ */ jsxs(DropdownMenuContent, {
			className: "w-[--radix-popper-anchor-width]",
			children: [/* @__PURE__ */ jsx(DropdownMenuItem, { children: /* @__PURE__ */ jsx("span", { children: "Admin" }) }), /* @__PURE__ */ jsx(DropdownMenuItem, { children: /* @__PURE__ */ jsx("span", { children: "Guest" }) })]
		})] }) }) }) }),
		/* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Main Menu" }), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => {
		...
		/* @__PURE__ */ jsx(SidebarFooter, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
			asChild: true,
			children: /* @__PURE__ */ jsxs(SidebarMenuButton, { children: ["Username", /* @__PURE__ */ jsx(ChevronUp, { className: "ml-auto" })] })
		}), /* @__PURE__ */ jsxs(DropdownMenuContent, {
			side: "top",
			align: "start",
			className: "w-full min-w-[--radix-dropdown-menu-trigger-width]",
			children: [
				/* @__PURE__ */ jsx(DropdownMenuItem, { children: /* @__PURE__ */ jsx("span", { children: "Account" }) }),
...
cva("text-sm shadow-none flex gap-2 items-center", {
	variants: { size: {
...
//#endregion
//#region src/components/Notification.tsx
function Notification() {
	...
	return /* @__PURE__ */ jsxs(Sheet, { children: [/* @__PURE__ */ jsx(SheetTrigger, {
		...
		children: /* @__PURE__ */ jsxs(Button, {
			...
			size: "icon",
			className: "relative",
			children: [/* @__PURE__ */ jsx(Bell, {}), unreadCount > 0 && /* @__PURE__ */ jsx(Dot, {
				size: 28,
				className: "absolute top-0 right-0 text-(--destructive) stroke-[3]"
			})]
		})
	}), /* @__PURE__ */ jsxs(SheetContent, { children: [
		/* @__PURE__ */ jsx(SheetHeader, { children: /* @__PURE__ */ jsx(SheetTitle, { children: "Notification" }) }),
		/* @__PURE__ */ jsx("div", {
			className: "flex-1 overflow-y-auto p-4 sm:p-6",
			children: notifications.map((notif) => /* @__PURE__ */ jsxs("a", {
				href: "#",
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsx(Mail, {}), !notif.isRead && /* @__PURE__ */ jsx(Dot, {
							size: 28,
					...
					children: [/* @__PURE__ */ jsxs("p", {
						...
						className: "truncate w-48 text-(--muted-foreground)",
						children: [
							" ",
							"Sent you a message.",
							" "
...
//#endregion
//#region src/layouts/AuthenticatedLayout.tsx
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(InputGroup, {
					className: "max-w-xs",
					children: [/* @__PURE__ */ jsx(InputGroupInput, { placeholder: "Search..." }), /* @__PURE__ */ jsx(InputGroupAddon, { children: /* @__PURE__ */ jsx(Search, {}) })]
				})
			]
		}), /* @__PURE__ */ jsxs("div", {
...
var $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "AuthenticatedLayout", AuthenticatedLayout, {
		"title": "Dashboard | Andre Austria",
		"client:load": true,
		"client:component-hydration": "load",
		"client:component-path": "@/layouts/AuthenticatedLayout",
		"client:component-export": "AuthenticatedLayout"
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<h1>Welcome ${email}</h1><p>We are happy to see you here</p><form action="/api/auth/signout"><button type="submit">Sign out</button></form>` })}`;
}, "C:/Users/andre/Documents/Solo Projects/Portfolio/src/pages/admin/dashboard.astro", void 0);
var $$file = "C:/Users/andre/Documents/Solo Projects/Portfolio/src/pages/admin/dashboard.astro";
